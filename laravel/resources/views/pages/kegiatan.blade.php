...
<div class="greennature-page-title-wrapper header-style-5-title-wrapper">
    ...
    <div class="greennature-page-title-container container">
        <h1 class="greennature-page-title">Kegiatan</h1>
        <span class="greennature-page-caption">Macam-macam kegiatan Suku Anak Dalam</span>
    </div>
</div>
                                                ...
                                                <article id="post-862" class="post-862 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-fit-row tag-blog tag-link tag-news">
                                                    <div class="greennature-standard-style">
                                                        <div class="greennature-blog-thumbnail">
                                                            <a href="{{ route('kegiatan-view', $item->id) }}"> <img src="{{ url($item->foto) }}" alt="" width="750" height="330" /></a>
                                                        </div>
                                                        ...
                                                        <div class="blog-content-wrapper">
                                                            <header class="post-header">
                                                                <h3 class="greennature-blog-title"><a href="{{ route('kegiatan-view', $item->id) }}">{{ $item->judul }}</a></h3>
                                                                <div class="clear"></div>
                                                            </header>
                                                            <!-- entry-header -->
