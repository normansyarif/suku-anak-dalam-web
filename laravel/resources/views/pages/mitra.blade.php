...
<div class="greennature-page-title-wrapper header-style-5-title-wrapper">
    ...
    <div class="greennature-page-title-container container">
        <h1 class="greennature-page-title">Mitra Kerjasama</h1>
    </div>
</div>
                                                ...
                                                <article id="post-862" class="post-862 post type-post status-publish format-standard has-post-thumbnail hentry category-blog category-fit-row tag-blog tag-link tag-news">
                                                    <div class="greennature-standard-style">
                                                        <div class="greennature-blog-thumbnail">
                                                            <a href="{{ route('mitra-view', $item->id) }}"> <img src="{{ url($item->foto) }}" alt="" width="750" height="330" /></a>
                                                        </div>

                                                        <div class="greennature-blog-date-wrapper">
                                                            <div class="greennature-blog-day">{{ date('d', strtotime($item->created_at)) }}</div>
                                                            <div class="greennature-blog-month">{{ date('M', strtotime($item->created_at)) }}</div>
                                                        </div>

                                                        <div class="blog-content-wrapper">
                                                            <header class="post-header">
                                                                <h3 class="greennature-blog-title"><a href="{{ route('mitra-view', $item->id) }}">{{ $item->judul }}</a></h3>
                                                                <div class="clear"></div>
                                                            </header>
                                                            <!-- entry-header -->
                            ...
                            <div class="greennature-item-start-content sidebar-right-item">
                                <div id="search-3" class="widget widget_search greennature-item greennature-widget">
                                    <div class="gdl-search-form">
                                        <form method="get" id="searchform" action="{{ route('mitra.search') }}">
                                    ...
                                    <div class="greennature-recent-port-widget">
                                        ...
                                        <div class="recent-post-widget">
                                            <div class="recent-post-widget-thumbnail">
                                                <a href="{{ route('mitra-view', $item->id) }}"><img src="{{ url($item->foto) }}" alt="" width="150" height="150" /></a>
                                            </div>
                                            <div class="recent-post-widget-content">
                                                <div class="recent-post-widget-title"><a href="{{ route('mitra-view', $item->id) }}">{{ $item->judul }}</a></div>
                                                <div class="recent-post-widget-info">
                                                    <div class="blog-info blog-date greennature-skin-info"><i class="fa fa-clock-o"></i><a href="{{ route('mitra-view', $item->id) }}">{{ date('j M Y', strtotime($item->created_at)) }}</a></div>
                                                    <div class="clear"></div>
                                                </div>
                                            </div>
                                            <div class="clear"></div>
