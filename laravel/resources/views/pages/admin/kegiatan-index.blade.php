		...
		<div class="col-md-12">
			...
			<section>
				...
				<div class="table-responsive">
					<a href="{{ route('admin.kegiatan.add') }}" class="btn btn-primary pull-right">Tambah</a>
					<table class="table">
						<thead>
							<tr>
								<th>Judul</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<a href="{{ route('kegiatan-view', $item->id) }}" class="btn btn-sm btn-primary">Lihat</a>
									<a href="{{ route('admin.kegiatan.edit', $item->id) }}" class="btn btn-sm btn-secondary">Edit</a>
									...
									">
									Publish
									<form method="post" action="{{ route('admin.kegiatan-publish', $item->id) }}">
										@csrf
