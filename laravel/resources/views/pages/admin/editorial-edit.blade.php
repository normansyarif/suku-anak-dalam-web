	...
	<div class="row">
		<div class="col-md-12">
			...
			<section>
				...
				<form method="post" action="{{ route('admin.editorial-update', $data->id) }}" enctype="multipart/form-data">
					<div class="row">
						<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-12">
							<h6>Teks narasi</h6>
							<textarea name="narasi" id="ckeditor" required placeholder="Narasi profil">{!! $data->konten !!}</textarea>
