	...
	<div class="row">
		<div class="col-md-12">
			...
			<section>
				...
				<form enctype="multipart/form-data" method="post" action="{{ route('admin.mitra-insert') }}">
					<div class="row">
						<div class="col-md-12">
					...
					<div class="row">
						...
						<div class="col-md-9 col-sm-12">
							<h6>Teks narasi</h6>
							<textarea name="narasi" id="ckeditor" required placeholder="Narasi mitra"></textarea>
